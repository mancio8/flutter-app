  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      body: RefreshIndicator(
        onRefresh: () async {
          ref.invalidate(raccoltaGiornoProvider);
          ref.invalidate(tuttiGiorniProvider);
        },
        child: CustomScrollView(
          physics: const AlwaysScrollableScrollPhysics(),
          slivers: [
            // AppBar coerente con Biblioteca
            SliverAppBar(
              expandedHeight: 120,
              floating: true,
              pinned: true,
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Orario conferimento — card con ombra, stile Biblioteca
                    Container(
